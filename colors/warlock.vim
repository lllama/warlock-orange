...
if ($TERM =~ '256' || &t_Co >= 256) || has("gui_running")
    ...
    hi IncSearch ctermbg=243 ctermfg=235 cterm=NONE guibg=red guifg=#262626 gui=NONE
    " hi Search cterm=NONE ctermfg=grey ctermbg=blue
    hi Search ctermbg=130 ctermfg=235 cterm=NONE guibg=red guifg=#262626 gui=NONE
...
elseif &t_Co == 8 || $TERM !~# '^linux' || &t_Co == 16
    ...
    hi IncSearch ctermbg=black ctermfg=red cterm=reverse
    hi Search ctermbg=130 ctermfg=red cterm=reverse
